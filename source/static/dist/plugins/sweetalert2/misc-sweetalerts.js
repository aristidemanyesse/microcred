...
successToastConfig = {
    ...
    buttonsStyling: !1,
    customClass: {
        confirmButton: defaultButtonClasses.confirmButton
    }
},
showAlert = t => {
    Swal.fire({
...
confirmBtn = (bindAlert("sweetalert-basic", {
    title: "Simple Alert",
...
paramsBtn = (confirmBtn && confirmBtn.addEventListener("click", () => {
    Swal.fire({
...
closeButton = (paramsBtn && paramsBtn.addEventListener("click", () => {
    Swal.fire({
        title: "Delete File?",
        ...
        t.isConfirmed ? showAlert({
            ...
            icon: "success"
        }) : t.dismiss === Swal.DismissReason.cancel && showAlert({
...
ajaxBtn = (closeButton && closeButton.addEventListener("click", () => {
    let t;
    Swal.fire({
        title: "Auto Dismiss",
        ...
        t.dismiss === Swal.DismissReason.timer && console.log("Alert closed by timer")
    })
}), bindPositionalAlert("position-top-start", "top-start"), bindPositionalAlert("position-top-end", "top-end"), bindPositionalAlert("position-bottom-start", "bottom-start"), bindPositionalAlert("position-bottom-end", "bottom-end"), bindAlert("sweetalert-info", {
...
ajaxBtn && ajaxBtn.addEventListener("click", () => {
    Swal.fire({
        ...
        preConfirm: n => new Promise((t, e) => {
            setTimeout(() => {
                "taken@example.com" === n ? e("This email is already registered.") : t(n)
            },
            1500)
        }),
        allowOutsideClick: !1
