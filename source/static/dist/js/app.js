        ...
        let t = new IntersectionObserver((e, n) => {
            e.forEach(o => {
                if (o.isIntersecting) {
                    ...
                    a = (t = parseFloat(t), 0),
                    i,
                    s = (i = Number.isInteger(t) ? Math.floor(t / 25) : t / 25, () => {
        ...
        if (o) {
            ...
            e = (s.forEach(e => {
                e.addEventListener("show.bs.collapse", e => {
                    ...
                    a = [],
                    i = t.parentElement;
                    for (; i && i !== o;) i.classList.contains("collapse") && a.push(i),
                    i = i.parentElement;
                    s.forEach(e => {
                ...
                if (e && t) {
                    ...
                    if (100 < e) {
                        ...
                        r = 0; ! function e() {
                            var t, a, i;
                            r += 20,
                            n.scrollTop = (t = r, a = s, i = o, (t /= l / 2) < 1 ? i / 2 * t * t + a : -i / 2 * (--t * (t - 2) - 1) + a),
                            r < l && setTimeout(e, 20)
                        } ()
                    }
                }
        ...
        if (i) {
            ...
            i.querySelectorAll("li a").forEach(e => {
                if (e.href === t) {
                    ...
                    for (let e = 0; e < 6 && t && t !== document.body; e++)"LI" !== t.tagName && !t.classList.contains("dropdown") || t.classList.add("active"),
                    t = t.parentElement
                }
            });
...
class CustomApexChart {
    ...
    render() {
        if (this.chart && this.chart.destroy(), this.element) {
            ...
            this.chart.render()
        } else console.warn(`CustomApexChart:  No element found
        for selector '${this.selector}'.`)
    }
    injectDynamicColors(e, a) {
        ...
        e.plotOptions.boxPlot.colors.upper = e.plotOptions.boxPlot.colors.upper || a[0], e.plotOptions.boxPlot.colors.lower = e.plotOptions.boxPlot.colors.lower || a[1]),
...
class CustomEChart {
    ...
    render() {
        try {
            ...
            this.element ? (e = this.getOptions(), this.chart = echarts.init(this.element, this.theme, this.initOptions), this.chart.setOption(e), window.addEventListener("resize", debounce(() => {
                this.chart.resize()
            },
            200))) : console.warn(`CustomEChart:  No element found
            for selector '${this.selector}'.`)
        } catch(e) {
            console.error(`CustomEChart:  Render error
            for '${this.selector}'`, e)
        }
    }
    static reSizeAll() {
        if (0 < CustomEChart.instances.length) for (let e of CustomEChart.instances) e.element && null !== e.element.offsetParent && requestAnimationFrame(() => {
            e.chart.on("finished", () => {
